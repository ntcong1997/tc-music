package com.example.tcmusic.feature.home.dancechart
...
class DanceChartViewModel @Inject constructor(
    ...
    val tracks = loadWorldChartByGenreUseCase(LoadWorldChartByGenreParams(GenreCode.DANCE.value)).map {
    ...
    fun refresh() {
        viewModelScope.launch {
            ...
            refreshWorldChartByGenreUseCase(GenreCode.DANCE.value)
