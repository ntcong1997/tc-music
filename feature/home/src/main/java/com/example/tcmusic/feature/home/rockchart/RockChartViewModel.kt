package com.example.tcmusic.feature.home.rockchart
...
class RockChartViewModel @Inject constructor(
    ...
    val tracks = loadWorldChartByGenreUseCase(LoadWorldChartByGenreParams(GenreCode.ROCK.value)).map {
    ...
    fun refresh() {
        viewModelScope.launch {
            ...
            refreshWorldChartByGenreUseCase(GenreCode.ROCK.value)
